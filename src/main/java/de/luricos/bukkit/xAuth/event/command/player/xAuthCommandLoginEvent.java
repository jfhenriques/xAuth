 ...
 */
package de.luricos.bukkit.xAuth.event.command.player;
...
public class xAuthCommandLoginEvent extends xAuthEvent {

    private static final HandlerList handlers = new HandlerList();

    public xAuthCommandLoginEvent(xAuthEventProperties properties) {
        super(properties);
    }
